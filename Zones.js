  ...
  for (let i = 0; i < 26; i++) {
    if (character1.leftEdgeOfFeet - 20 >= arrayOfZones[i].leftEdge && character1.rightEdgeOfFeet - 27 <= arrayOfZones[i].rightEdge &&
        character1.topEdgeOfFeet -25 >= arrayOfZones[i].topEdge && character1.bottomEdgeOfFeet - 29 <= arrayOfZones[i].bottomEdge) {
          arrayOfZones[i].character1InTheZone = true;
          arrayOfZones[i].claimStatus = "character1InTheZone";
        }
    else if (character2.leftEdgeOfFeet >= arrayOfZones[i].leftEdge && character2.rightEdgeOfFeet <= arrayOfZones[i].rightEdge &&
        character2.topEdgeOfFeet >= arrayOfZones[i].topEdge && character2.bottomEdgeOfFeet >= arrayOfZones[i].bottomEdge) {
          arrayOfZones[i].character2InTheZone = true;
          arrayOfZones[i].claimStatus = "character2InTheZone";
        }
    else {
        arrayOfZones[i].claimStatus = "unclaimed";
    }
