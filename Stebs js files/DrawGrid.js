...
function drawQuadrilateralZone(x1,y1, x2,y2, x3,y3, x4,y4, zoneNumber, claimStatus) {
  ...
  if (claimStatus === "empty") {
    canvasContext.fillStyle = "";
    canvasContext.fill();
  }
  if (claimStatus === "character1InTheZone") {
    canvasContext.fillStyle = "blue";
    canvasContext.fill();
  } else if (claimStatus === "character2InTheZone") {
    canvasContext.fillStyle = "green";
    canvasContext.fill();
  } else if (claimStatus === "claimDanger") {
...
function drawPentagonalZone(x1,y1, x2,y2, x3,y3, x4,y4, x5,y5, zoneNumber, claimStatus) {
  canvasContext.beginPath();
  canvasContext.moveTo(x1,y1);
  canvasContext.lineTo(x2,y2);
  canvasContext.lineTo(x3,y3);
...
//  }
 if (claimStatus === "character1InTheZone") {
    canvasContext.fillStyle = "blue";
    canvasContext.fill();
  } else if (claimStatus === "character1InTheZone") {
    canvasContext.fillStyle = "green";
    canvasContext.fill();
  } else if (claimStatus === "claimDanger") {
    canvasContext.fillStyle = "red";
