    ...
    if (!this.isAI) {
      if(this.keyHeld_North) {
  			nextY -= PLAYER_MOVE_SPEED;
				console.log("player", character1.topEdgeOfFeet);
				console.log("zone1", arrayOfZones[0].topEdge);
				console.log("zone2", arrayOfZones[1].topEdge);
        ...
        // this.facingDirection = 1;
  		...
  		if(this.keyHeld_South) {
  			nextY += PLAYER_MOVE_SPEED;
				...
				console.log("zone1", arrayOfZones[0].topEdge);
				console.log("zone2", arrayOfZones[1].topEdge);
				//character1.bottomEdgeOfFeet,arrayOfZones[0].topEdge);
